...
//        try {
             socket = new Socket();
        Log.i(StartActivity.TAG," SocketCreat() ");
...
//        }
    ...
    public boolean socketLink(String IP,int PORT) {
        Log.i(StartActivity.TAG," socketLink() ");
        ...
        try {
            ...
            Log.i(StartActivity.TAG," socketLink() SocketTimeoutException");
        } catch (IOException e) {

        } finally {
            connected = socket.isConnected();
            Log.i(StartActivity.TAG," connected: "+connected);
